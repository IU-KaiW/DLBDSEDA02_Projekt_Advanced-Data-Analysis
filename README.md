...
|-----|------------------------------------|-----------|-----------|----------------|--------------------------------------------------------------------------------------|
| 1   | Consumer_Complaints.csv            | n/a       | 59,40  MB | [^1]. Kaggle       | [Kaggle](https://www.kaggle.com/datasets/ashwinik/)consumer-complaints-financial-products      |
| 2   | rows.csv                           | n/a       | 176    MB | [^2]. Kaggle        | https://www.kaggle.com/datasets/selener/consumer-complaint-database                  |
