...
<ul>
  ...
  Die Zeilen der Spalte enthalten jeweils den alphanumerischen `<Benutzernamen>` des Beschwerdeverfassers sowie eine, durch ein "of" getrette, US-Ortsangabe welche im Format ```python
  `<Ortsname , US-Bundesstaat>`
  ``` vorliegt.<br>
