...
<ul>
  ...
  Die Zeilen der Spalte enthalten jeweils den alphanumerischen`<Benutzernamen>` des Beschwerdeverfassers sowie eine, durch ein "of" getrette, US-Ortsangabe welche im Format `<Ortsname , US-Bundesstaat>`
 vorliegt.
